...
import * as sty from "./PlasmicButton.module.css"; // plasmic-import: LPkJNTjVmA5d/css
import MenuIcon from "./icons/PlasmicIcon__Menu"; // plasmic-import: Mr0P4aP4YFI_/icon
      ...
      {(
        ...
        <div
          className={classNames(
            ...
            sty.freeBox__hUw8V,
            {
              [sty.freeBox__iconOnly__hUw8VWEy]: hasVariant(
                variants,
                "iconOnly",
                "iconOnly"
              ),

              [sty.freeBox__showEndIcon__hUw8VaSfz]: hasVariant(
                variants,
                "showEndIcon",
                "showEndIcon"
              ),

              [sty.freeBox__showStartIcon__hUw8VzhlP0]: hasVariant(
                variants,
                "showStartIcon",
                "showStartIcon"
              ),

              [sty.freeBox__size_large__hUw8VsCmk7]: hasVariant(
                variants,
                "size",
                "large"
              ),

              [sty.freeBox__size_small__hUw8VPuaAv]: hasVariant(
                variants,
                "size",
                "small"
              )
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        <div
          className={classNames(
            ...
            sty.freeBox__rNgrF,
            {
              [sty.freeBox__showEndIcon__rNgrFaSfz]: hasVariant(
                variants,
                "showEndIcon",
                "showEndIcon"
              ),

              [sty.freeBox__size_small__rNgrFPuaAv]: hasVariant(
                variants,
                "size",
                "small"
              )
