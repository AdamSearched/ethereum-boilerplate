...
import * as sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: iwL33CZyF6Wv/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Gvwa1hVDjNxF/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__jDgrS)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__wmh2N)}
              />
            </React.Fragment>
          ),
