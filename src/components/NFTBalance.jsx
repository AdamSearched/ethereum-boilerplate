//component for the NFT page, using hooks and setting states from data
//recieved. Also handles transfers.
//The card, image, tooltp components are all used here
